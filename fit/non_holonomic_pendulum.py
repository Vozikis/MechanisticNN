...
base_directory = "Videos/holonomic_pendulum/06_11_2024/fps_30"
num_trajectories = 15
...
for trajectory_number in range(num_trajectories):
    ...
    if os.path.exists(file_path):
        ...
        if trajectory_number == 6:
            ...
            traj_x = traj_x[:380]
        elif trajectory_number == 18:
            traj_x = traj_x[:300]
        elif trajectory_number == 19:
            traj_x = traj_x[:300]
        elif trajectory_number == 20:
            traj_x = traj_x[:300]
